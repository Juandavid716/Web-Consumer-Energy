...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <div class="navbar-nav ml-auto">
      ...
      <a class="nav-item nav-link" href="comunicacion.php">Comentarios</a>
     <a class="nav-item nav-link mr-3" href="calculos.php">Calculos</a>
<div> 
       <a href="cerrarsesion.php" class="btn btn-danger"> Exit</a>
       </div>
